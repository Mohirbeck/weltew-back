...
class ProductModel(models.Model):
    ...
    price = models.FloatField(
        null=True, blank=True, verbose_name="Цена", default=0, help_text="Цена в рублях",)
    ...
    manufacturer = models.ForeignKey('ManufacturerModel', on_delete=models.CASCADE, null=True,
                                     blank=True, verbose_name="Производитель", related_name="product_manufacturer")
    ...
    code = models.CharField(max_length=255, default='',
                            verbose_name="Артикуль", null=True, blank=True)
    category = models.ForeignKey('ProductCategoryModel', on_delete=models.DO_NOTHING, default=None,
                                 null=True, blank=True, verbose_name="Категория", related_name="product_category")
    assembly = models.FileField(
        upload_to='assembly/', default='', verbose_name="Сборка", null=True, blank=True)
    features = models.JSONField(
        null=True, blank=True, verbose_name="Характеристики")
    url = models.URLField(
        max_length=255, verbose_name="Ссылка", null=True, blank=True)
    is_active = models.BooleanField(default=True, verbose_name="Активность")
    sklad_cat = models.CharField(
        max_length=255, default='', verbose_name="Категория склада", null=True, blank=True)
    sklad_cat_2 = models.CharField(
        max_length=255, default='', verbose_name="Категория склада 2", null=True, blank=True)
    sklad_collection = models.CharField(
        max_length=255, default='', verbose_name="Коллекция склада", null=True, blank=True)
...
class Product3DModel(models.Model):
    ...
    product = models.ForeignKey('ProductModel', on_delete=models.CASCADE,
                                null=True, blank=True, verbose_name="Продукт", related_name="product_3d")
...
class CollectionModel(models.Model):
    ...
    manufacturer = models.ForeignKey('ManufacturerModel', on_delete=models.CASCADE, null=True,
                                     blank=True, verbose_name="Производитель", related_name="collection_manufacturer")
    default_products = models.ManyToManyField(
        ProductModel, blank=True, related_name='default_products', verbose_name="Товары по умолчанию")
    url = models.URLField(default='')
    category = models.ForeignKey('CollectionCategoryModel', on_delete=models.DO_NOTHING, default=None,
                                 null=True, blank=True, verbose_name="Категория", related_name="collection_category")
...
class CollectionImagesModel(models.Model):
    ...
    collection = models.ForeignKey(
        'CollectionModel', on_delete=models.CASCADE, related_name='images', null=True, blank=True)
...
class ProductImagesModel(models.Model):
    ...
    product = models.ForeignKey(
        'ProductModel', on_delete=models.CASCADE, related_name='images', null=True, blank=True)
    url = models.URLField(default='', null=True,
                          blank=True, verbose_name="Ссылка")
...
class CartModel(models.Model):
    customer = models.ForeignKey('Customer', on_delete=models.CASCADE,
                                 verbose_name='Пользователь', related_name='cart', null=True, blank=True)
    product = models.ForeignKey('ProductModel', on_delete=models.CASCADE,
                                verbose_name='Товар', related_name='cart', blank=True, null=True)
...
class CustomerCollectionModel(models.Model):
    customer = models.ForeignKey('Customer', on_delete=models.CASCADE,
                                 verbose_name='Пользователь', related_name='collections', null=True, blank=True)
    collection = models.ForeignKey('CollectionModel', on_delete=models.CASCADE,
                                   verbose_name='Товар', related_name='customer_collection', blank=True, null=True)
...
class CustomerCollectionItemModel(models.Model):
    product = models.ForeignKey('ProductModel', blank=True, related_name='customer_collection_products',
                                verbose_name="Товары", on_delete=models.CASCADE)
    quantity = models.IntegerField(verbose_name='Количество', default=1)
    collection = models.ForeignKey('CustomerCollectionModel', on_delete=models.CASCADE,
                                   verbose_name='Коллекция', related_name='customer_collection_products', blank=True, null=True)
...
class OrderItemModel(models.Model):
    product = models.ForeignKey('ProductModel', blank=True, related_name='orders',
                                verbose_name="Товары", on_delete=models.CASCADE)
    quantity = models.IntegerField(verbose_name='Количество', default=1)
    order = models.ForeignKey('OrderModel', on_delete=models.CASCADE,
                              verbose_name='Заказ', related_name='products', blank=True, null=True)
...
class ReviewModel(models.Model):
    product = models.ForeignKey('ProductModel', on_delete=models.CASCADE,
                                related_name='reviews', null=True, blank=True, verbose_name="Продукт")
...
class ReviewImageModel(models.Model):
    ...
    review = models.ForeignKey('ReviewModel', on_delete=models.CASCADE,
                               related_name='images', null=True, blank=True, verbose_name="Отзыв")
...
class FavoriteModel(models.Model):
    ...
    product = models.ForeignKey('ProductModel', on_delete=models.CASCADE,
                                verbose_name='Товар', related_name='favorite', blank=True, null=True)
...
class CRMModel(models.Model):
    secret_key = models.CharField(
        max_length=255, verbose_name='Секретный ключ')
    ...
    redirect_uri = models.CharField(
        max_length=255, verbose_name='URI перенаправления')
